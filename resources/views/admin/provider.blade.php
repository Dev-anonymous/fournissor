...
<head>
    ...
    <title> Business | {{ config('app.name') }} </title>
    <x-css-file />
</head>
                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card">
                            <div class="card-header d-flex justify-content-between">
                                <div class="card-title">Comptes Business</div>
            ...
            <div class="modal-dialog  text-center" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">Nouveau business </h6>
                    ...
                    <form action="#" id="f-add">
                        <div class="modal-body text-start">
                            ...
                            <div class="col-xl-12 mb-3">
                                <label for="signin-username" class="form-label text-default">Nom du responsable</label>
                                <input required type="text" name="name" class="form-control form-control-sm"
                                    id="signin-username" placeholder="Nom">
                            </div>
                            <div class="col-xl-12 mb-3">
                                <label for="signin-username" class="form-label text-default">Nom du business</label>
                                <input required type="text" name="businessname" class="form-control form-control-sm"
                                    id="signin-username" placeholder="Nom du business">
                            </div>
                            <div class="col-xl-12 mb-3">
                                <label for="signin-username" class="form-label text-default">Catégorie du
                                    business</label>
                            ...
                            <div class="col-xl-12 mb-3">
                                <label for="signin-username" class="form-label text-default">Téléphone du
                                    business</label>
                                <input required type="text" id="phone" class="form-control form-control-sm phone"
                                    placeholder="Téléphone">
                            </div>
                            <div class="col-xl-12 mb-3">
                                <label for="signin-username" class="form-label text-default">Email du business</label>
                                <input required type="email" name="email" class="form-control form-control-sm"
                                    id="signin-username" placeholder="Email">
                            </div>
                            <div class="col-xl-12 mb-3">
                                <label for="text-area" class="form-label">Logo/Affiche du business</label>
                                <input type="file" class="filepond1" required name="logo"
                                    accept="image/png, image/jpeg" data-max-file-size="500KB" data-max-files="1">
                            </div>
                            <div class="col-xl-12 mb-3">
                                <label for="signin-username" class="form-label text-default">Description du
                                    business</label>
                                <textarea name="description" required class="form-control" rows="3" placeholder="Description"></textarea>
                            </div>
                ...
                <div class="modal-content modal-content-demo">
                    ...
                    <form action="#" id="f-edit">
                        <div class="modal-body text-start">
                            ...
                            <div class="col-xl-12 mb-3">
                                <label for="signin-username" class="form-label text-default">Nom du
                                    responsable</label>
                                <input required type="text" name="name" class="form-control form-control-sm"
                                    id="signin-username" placeholder="Nom">
                            </div>
                            ...
                            <div class="col-xl-12 mb-3">
                                <label for="text-area" class="form-label">Logo/Affiche du business (optionnel)</label>
                                <input type="file" class="filepond2" name="logo"
                                    accept="image/png, image/jpeg" data-max-file-size="500KB" data-max-files="1">
                            </div>
                            <div class="col-xl-12 mb-3">
                                <label for="signin-username" class="form-label text-default">Description du
                ...
                <div class="modal-content modal-content-demo">
                    <form action="#" id="fdel">
                        <div class="modal-body text-start">
                            ...
                            <p class="text-danger h5 font-weight-bold">
                                <i class="bx bx-info-circle"></i>
                                Attention ! Tous les services et les cotations de ce business seront également
                                supprimés.
                            </p>
                            <div class="mt-2">
                                <div id="rep"></div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function getdata() {
                ...
                $.ajax({
                    'url': '{{ route('users.index', ['type' => 'provider']) }}',
                    success: function(res) {
                        table.DataTable().destroy();
                        var html = '';
                        res.data.forEach((user, i) => {
                            html += `<tr title="${user.businesses[0].description}">
                            <td>${i+1}</td>
                            <td><img src="{{ asset('storage') }}/${user.businesses[0].logo}" alt="img" width="32" height="32" class="rounded-circle"></td>
                            <td>Business : ${user.businesses[0].businessname} <br>
                                Responsable : ${user.name}
                            </td>
                            <td>${user.businesses[0].category.category}</td>
                            <td>
                                ${user.phone??'-'}<br>
                                ${user.email??'-'}
                             </td>
                            <td>
                                <div class='d-flex justify-content-end'>
                                    ...
                                    <a class="btn btn-success btn-sm m-1"  value="${user.id}" ><i class='bx bx-menu'></i> Détails</a>
                                </div>
                            </td>
                        </tr>
                        `;
                        ...
                        $('[bedit]').off('click').click(function() {
                            ...
                            $('[name=businessname]', mdl).val(data.businesses[0].businessname);
                            $('[name=description]', mdl).val(data.businesses[0].description);
                            $('[name=email]', mdl).val(data.email);
                            $('#phone2').html(
                                `<input required type="text" class="form-control form-control-sm phone2" placeholder="Téléphone">`
                            );
                            $('.phone2', mdl).val(data.phone);
                            intlTelInput($('.phone2')[0], {
                                geoIpLookup: function(callback) {
