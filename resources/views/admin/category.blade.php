...
<head>
    ...
    <title> Catégorie de Business | {{ config('app.name') }} </title>
    <x-css-file />
</head>
                    ...
                    <div class="ms-md-1 ms-0">
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Catégorie de Business</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="col-xl-12 mb-3">
                        <div class="card custom-card">
                            <div class="card-header d-flex justify-content-between">
                                <div class="card-title">Catégorie de Business</div>
            ...
            <div class="modal-dialog  text-center" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">Nouvelle Catégorie de Business </h6>
                    ...
                    <form action="#" id="f-add">
                        <div class="modal-body text-start">
                            <div class="col-xl-12 mb-3">
                                ...
                                <input required type="text" name="category" class="form-control form-control-sm"
                                    id="signin-username">
                            </div>
                            <div class="col-xl-12 mb-3">
                                <label for="signin-username" class="form-label text-default">
                                ...
                                <textarea name="description" id="" required rows="3" class="form-control" placeholder="Description"
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        $('[bedit]').off('click').click(function() {
                            ...
                            $('[name=category]', mdl).val(data.category);
